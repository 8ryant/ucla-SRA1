classdef MEAOne < symphonyui.core.descriptions.RigDescription
    ...
    methods
        ...
        function obj = MEAOne()
            ...
            rigDev = manookinlab.devices.RigPropertyDevice('FieldLab','MEA One');   %%%% what does this do?
            obj.addDevice(rigDev);

            amp1 = MultiClampDevice('Amp1', 1).bindStream(daq.getStream('ao0')).bindStream(daq.getStream('ai0'));  %%% why is this needed?
            obj.addDevice(amp1);
